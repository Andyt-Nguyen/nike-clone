...
//LifeStyle
	...
	$scope.BLSlength = $scope.NikeBLSPics.length
...
//Running
	...
	$scope.BRnlength = $scope.NikeBRnPics.length;
...
//Basketball
	...
	$scope.BBlength = $scope.NikeBBPics.length;
...
//Soccer
	...
	$scope.BSLength = $scope.NikeBSPics.length;
...
//Training
	...
	$scope.BTGLength = $scope.NikeBTGPics.length;
